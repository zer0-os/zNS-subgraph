...
export class Node {
  static emptyArray: Node[] = new Array<Node>();
...
export class AssertionNode extends Node {
  ...
  static is(node: Node, kind: Char = Char.None): bool {
    return (
      node.type == NodeType.Assertion && ((node as AssertionNode).kind == kind || kind == Char.None)
    );
  }
...
export class RepetitionNode extends Node {
  constructor(public expression: Node, public quantifier: Char, public greedy: bool = true) {
...
export class GroupNode extends Node {
  ...
  constructor(public expression: Node, public capturing: bool, public id: i32 = -1) {
